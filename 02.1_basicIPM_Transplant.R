# 02.1_basicIPM_Transplant.R
############################################################################################
##
##      M A I N     I P M    S C R I P T 
##		
##		Modified for Mimulus cardinalis transplant dataset (August 2015)
## 
###########################################################################################
...
# Fill m.par lists with site values.
	...
	m.par.CALAPOOIA["grow.sd"] = sigma(grow_model)
...
setwd(path.obj)
write.csv(siteLambdas, file="siteLambdas.csv")
